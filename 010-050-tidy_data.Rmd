...
For example, we can ask how does the average tumor volume change for each treatment group across the days?
...
So we would fix that problem first (Panel A in Figure 6.4).
